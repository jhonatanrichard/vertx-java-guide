...
public class AuthInitializerVerticle extends AbstractVerticle {
  ...
  public void start() throws Exception {
     ...
     *    baz / baz
     */
    List<String> dataInit = Arrays.asList( // 1. The hashed values can be generated using auth.computeHash(password, salt) where auth is a JDBCAuth instance. Salt values can also be generated using auth.generateSalt().
